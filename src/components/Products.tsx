export default function Products() {
  return (
    <section id="products" className="section" style={{ background: 'rgba(255,255,255,0.02)' }}>
      <div className="container">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '3rem' }}>
          ...
          <div className="glass" style={{ padding: '3rem' }}>
            <h3 style={{ color: 'var(--primary)', marginBottom: '1.5rem', fontSize: '1.5rem', borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '0.5rem' }}>
              Lower Extremity Prosthetics
            </h3>
            <ul style={{ color: 'rgba(255, 255, 255, 0.8)', paddingLeft: '1.5rem', lineHeight: 1.8, display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
          ...
          {/* Upper Extremity */}
          <div className="glass" style={{ padding: '3rem' }}>
            <h3 style={{ color: 'var(--secondary)', marginBottom: '1.5rem', fontSize: '1.5rem', borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '0.5rem' }}>
          ...
          {/* Custom Orthotics */}
          <div className="glass" style={{ padding: '3rem' }}>
            <h3 style={{ color: 'var(--accent)', marginBottom: '1.5rem', fontSize: '1.5rem', borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '0.5rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
            ...
            <div className="glass" style={{ padding: '2rem' }}>
              ...
              <ul style={{ color: 'rgba(255, 255, 255, 0.8)', paddingLeft: '1.5rem', lineHeight: 1.7, display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
